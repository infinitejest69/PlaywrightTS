...
export class Client {
   ...
   */
  petUploadImage(petId: number, additionalMetadata: string | null | undefined, file: FileParameter | null | undefined): Promise<ApiResponse> {
    ...
    if (additionalMetadata !== null && additionalMetadata !== undefined) content_.append('additionalMetadata', additionalMetadata.toString());
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processPetUploadImage(_response);
    });
  }

  protected processPetUploadImage(response: Response): Promise<ApiResponse> {
  ...
  petPost(body: Pet): Promise<void> {
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processPetPost(_response);
    });
  }

  protected processPetPost(response: Response): Promise<void> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  petPut(body: Pet): Promise<void> {
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processPetPut(_response);
    });
  }

  protected processPetPut(response: Response): Promise<void> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   * @return successful operation
   */
  petFindByStatus(status: Status[]): Promise<Pet[]> {
    let url_ = this.baseUrl + '/pet/findByStatus?';
    if (status === undefined || status === null) throw new Error("The parameter 'status' must be defined and cannot be null.");
    else
      status &&
        status.forEach((item) => {
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processPetFindByStatus(_response);
    });
  }

  protected processPetFindByStatus(response: Response): Promise<Pet[]> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   * @deprecated
   */
  petFindByTags(tags: string[]): Promise<Pet[]> {
    let url_ = this.baseUrl + '/pet/findByTags?';
    if (tags === undefined || tags === null) throw new Error("The parameter 'tags' must be defined and cannot be null.");
    else
      tags &&
        tags.forEach((item) => {
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processPetFindByTags(_response);
    });
  }

  protected processPetFindByTags(response: Response): Promise<Pet[]> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   * @return successful operation
   */
  petGet(petId: number): Promise<Pet> {
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processPetGet(_response);
    });
  }

  protected processPetGet(response: Response): Promise<Pet> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   */
  petPostID(petId: number, name: string | null | undefined, status: string | null | undefined): Promise<void> {
    let url_ = this.baseUrl + '/pet/{petId}';
    if (petId === undefined || petId === null) throw new Error("The parameter 'petId' must be defined.");
    url_ = url_.replace('{petId}', encodeURIComponent('' + petId));
    url_ = url_.replace(/[?&]$/, '');
    ...
    let content_ = '';
    if (name !== undefined) content_ += encodeURIComponent('name') + '=' + encodeURIComponent('' + name) + '&';
    if (status !== undefined) content_ += encodeURIComponent('status') + '=' + encodeURIComponent('' + status) + '&';
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processPetPostID(_response);
    });
  }

  protected processPetPostID(response: Response): Promise<void> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   */
  petDelete(api_key: string | null | undefined, petId: number): Promise<void> {
    let url_ = this.baseUrl + '/pet/{petId}';
    if (petId === undefined || petId === null) throw new Error("The parameter 'petId' must be defined.");
    url_ = url_.replace('{petId}', encodeURIComponent('' + petId));
    url_ = url_.replace(/[?&]$/, '');
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processPetDelete(_response);
    });
  }

  protected processPetDelete(response: Response): Promise<void> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   * @return successful operation
   */
  storeOrderPost(body: Order): Promise<Order> {
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processStoreOrderPost(_response);
    });
  }

  protected processStoreOrderPost(response: Response): Promise<Order> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   * @return successful operation
   */
  storeOrderGet(orderId: number): Promise<Order> {
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processStoreOrderGet(_response);
    });
  }

  protected processStoreOrderGet(response: Response): Promise<Order> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   */
  storeOrderDelete(orderId: number): Promise<void> {
    let url_ = this.baseUrl + '/store/order/{orderId}';
    if (orderId === undefined || orderId === null) throw new Error("The parameter 'orderId' must be defined.");
    url_ = url_.replace('{orderId}', encodeURIComponent('' + orderId));
    url_ = url_.replace(/[?&]$/, '');
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processStoreOrderDelete(_response);
    });
  }

  protected processStoreOrderDelete(response: Response): Promise<void> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   * @return successful operation
   */
  storeInventory(): Promise<{ [key: string]: number }> {
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processStoreInventory(_response);
    });
  }

  protected processStoreInventory(response: Response): Promise<{ [key: string]: number }> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
      ...
      return response.text().then((_responseText) => {
        ...
        if (resultData200) {
          ...
          for (let key in resultData200) {
            if (resultData200.hasOwnProperty(key)) (<any>result200)![key] = resultData200[key] !== undefined ? resultData200[key] : <any>null;
          }
        } else {
          result200 = <any>null;
        }
   ...
   * @return successful operation
   */
  userCreateWithArray(body: User[]): Promise<void> {
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processUserCreateWithArray(_response);
    });
  }

  protected processUserCreateWithArray(response: Response): Promise<void> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   * @return successful operation
   */
  userCreateWithList(body: User[]): Promise<void> {
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processUserCreateWithList(_response);
    });
  }

  protected processUserCreateWithList(response: Response): Promise<void> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   * @return successful operation
   */
  userGet(username: string): Promise<User> {
   ...
   */
  userPut(username: string, body: User): Promise<void> {
    let url_ = this.baseUrl + '/user/{username}';
    if (username === undefined || username === null) throw new Error("The parameter 'username' must be defined.");
    url_ = url_.replace('{username}', encodeURIComponent('' + username));
    url_ = url_.replace(/[?&]$/, '');
  ...
  userLogin(username: string, password: string): Promise<string> {
    ...
    if (username === undefined || username === null) throw new Error("The parameter 'username' must be defined and cannot be null.");
    else url_ += 'username=' + encodeURIComponent('' + username) + '&';
    if (password === undefined || password === null) throw new Error("The parameter 'password' must be defined and cannot be null.");
  ...
  protected processUserLogin(response: Response): Promise<string> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  userLogout(): Promise<void> {
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processUserLogout(_response);
    });
  }

  protected processUserLogout(response: Response): Promise<void> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   * @return successful operation
   */
  userPost(body: User): Promise<void> {
