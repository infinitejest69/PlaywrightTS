...
test('search for "test" shows "Writing Tests" in results 2 @Smoke', async ({ CommonPage, page }) => {
  await page.goto('/');
...
test('should show Page Object Model article 2 @Smoke', async ({ PlaywrightDevPage, page }) => {
  await page.goto('/');
